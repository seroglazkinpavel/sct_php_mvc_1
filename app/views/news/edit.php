                        ...
                        <?php if (!empty($news)) : ?>
                            ...
                            <div class="input_box">
                                ...
                                <input type="text"
                                       ...
                                       value="<?= !empty($_POST['news']['short_description']) ? $_POST['news']['short_description'] : (!empty($news['short_description']) ? $news['short_description'] : '') ?>"
                                       max length="255"
                                >
                            </div>
                            <div class="input_box">
                                ...
                                ><?= !empty($_POST['news']['description']) ? $_POST['news']['description'] : (!empty($news['description']) ? $news['description'] : '') ?></textarea>
                            </div>
